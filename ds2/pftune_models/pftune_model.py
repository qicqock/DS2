...
from transformers.models.bart.modeling_bart import shift_tokens_right # transformers version issue
...
from ds2.pftune_models.lightning_base import BaseTransformer, PrefixTransformer, add_generic_args, generic_train
...
class PrefixDS2(PrefixTransformer):
    ...
    def __init__(self, args, qa_model, **kwargs):
        ...
        super().__init__(args, num_labels=None, mode= self.mode, **kwargs)
        use_task_specific_params(self.model, "summarization")
        # save_git_info(self.hparams.output_dir)
        # self.metrics_save_path = Path(self.output_dir) / "metrics.json"
        # self.hparams_save_path = Path(self.output_dir) / "hparams.pkl"
