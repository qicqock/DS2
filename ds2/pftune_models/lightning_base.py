...
# Initialize or load model and tokenizer, and prepare prefixTuning
class PrefixTransformer(pl.LightningModule):
    def __init__(
        ...
        **config_kwargs
        ...
        # save_hyperparameters() : enable lightning to store all the provided arguments under the self.hparams attribute. 
    ...
    def add_model_specific_args(parser, root_dir):
        parser.add_argument(
            "--model_name_or_path",
            default="Saleforce/bart-large-xsum-samsum",
            type=str,
            required=True,
